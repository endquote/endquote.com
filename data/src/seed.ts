  ...
  const homes: Array<Prisma.homeCreateInput> = [
    {
      ...
      start: new Date("1997-06-01").getTime() / 1000,
      end: new Date("2015-03-20T23:59:59").getTime() / 1000,
      airports: ["SEA"],
    },
    {
      name: "San Francisco",
      ...
      start: new Date("2015-03-21").getTime() / 1000,
      end: new Date("2079-01-01").getTime() / 1000,
      airports: ["SFO", "OAK"],
    },
  ];
