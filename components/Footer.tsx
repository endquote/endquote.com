...
export default function Footer({ strings, nosubscribe = false }) {
  return (
    <footer className="text-white mt-5">
      <div className="container">
        <div className="row">
          <div className={`col col-sm-12 col-md-6 col-lg-6 mb-5`}>
          ...
          <div
            className={`col col-sm-12 col-md-6 col-lg-6 mb-5 ${
              nosubscribe ? "d-none" : ""
            }`}
          >
